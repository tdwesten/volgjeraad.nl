                        ...
                        <ol className="space-y-6 sm:grid sm:grid-cols-4 sm:gap-4 sm:space-y-0">
                            {processSteps.map((step, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        {/* Verticale verbindingslijn naar de volgende stap (mobiel). */}
                                        {!isLast && (
                                            <span
                                                aria-hidden="true"
                                        ...
                                        {/* Horizontale verbindingslijn naar de volgende stap (desktop): van
                                            deze cirkel naar de volgende, inclusief de grid-gap (1rem). */}
                                        {!isLast && (
                                            <span
                                                aria-hidden="true"
